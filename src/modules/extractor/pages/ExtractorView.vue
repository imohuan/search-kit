  ...
  <div class="h-full flex flex-col overflow-hidden">
    ...
    <div v-else class="h-full flex flex-col overflow-hidden">
      ...
      <div class="flex border-b border-slate-100 bg-white relative shrink-0">
        ...
        <!-- 滑动指示器 -->
        <div
          class="absolute bottom-0 h-0.5 bg-indigo-600 transition-all duration-300 w-1/2"
      ...
      <div class="flex-1 overflow-hidden relative">
        <!-- 选字面板 -->
        <CharGrid
          v-show="innerTab === 'select'"
          :char-list="charList"
          :selected-indices="selectedIndices"
          :hide-spaces="hideSpaces"
          :extracted-list="extractedListForGrid"
      ...
      <ExtractorToolbar
        ...
        @back="backToInput"
        @toggle-hide-spaces="toggleHideSpaces"
        @clear-symbols="clearSymbols"
        @select-all="selectAll"
        @invert-selection="invertSelection"
        @clear-selection="clearSelection"
        @extract="handleAction"
